<?php
	...
	$sel_lr = "select lr.*, CONVERT(VARCHAR(10), lr.LR_DATE,105) as LR_DATE, CONVERT(VARCHAR(10), lr.EXP_DEL_DATE,105) as EXP_DEL_DATE from lr where lr.ID = ".$ID;
	...
	if($action != ''){
		...
		$sql = "update lr SET LR_DATE = '".$LR_DATE."', LR_TYPE = '".$LR_TYPE."', FROM_BRANCH = '".$FROM_BRANCH."', TO_BRANCH = '".$TO_BRANCH."', CONSR = '".$CONSR."', 
				...
				SHIPPER = '".$SHIPPER."', DELIVERY_AT = '".$DELIVERY_AT."', GOODS = '".$GOODS."', QUANTITY = '".$QUANTITY."', NO_OF_PKGS = '".$NO_OF_PKGS."', CHARGED_RATE = '".$CHARGED_RATE."', MIN_RATE = '".$MIN_RATE."',  
													...
													<div class="span5">
														<fieldset>
															<div class="control-group">											
																...
																<div class="controls">
																	<input type="text" name="LR_DATE" value="<?=$D_LR_DATE?>" id="LR_DATE" class="span2 validate[required] tcal" tabindex="1">
																</div> 				
															</div> 
															<div class="control-group">											
