<?php
	...
	$sel_lr = "select lr.*, CONVERT(VARCHAR(10), lr.LR_DATE,110) as LR_DATE, CONVERT(VARCHAR(10), lr.DELIVERY_DATE,110) as DELIVERY_DATE from lr where lr.ID = ".$ID;
	//echo $sel_lr;
...
<style>table {border-collapse: collapse;}table, tr, th { border: 0px solid black;height:20px;}tr{font-size:12px;font-family:"Arial";font-weight:600;}table{border:0.1px solid;}td{padding:5px;}</style>
	<table width="700" border="1" cellspacing="0" cellpadding="0">
		...
		<tr>
			<th colspan="3" style="height:80px;"><h3><u>Delivery Receipt</u></h3></th>
		</tr>
		<tr style="height:40px;">
			<th style="background-color:silver;"><u>Booking No</u></th>
			<th style="background-color:silver;"><u>Booking Date</u></th>
			<th style="background-color:silver"><u>Delivery Date</u></th>
		</tr>
		<tr style="height:40px;">
			<th><?=$LR_NUMBER?></th>
			<th><?=$LR_DATE?></th>
			...
			<th colspan="3">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr style="height:130px;">
						<td colspan="1"><u>Remarks</u></br />
							<?=$REMARKS?><br /><br /><br /><br />
						</td>
						<td colspan="2" align="right">
							The shipment has been received in good condition
							<br /><br /><br /><br /><br />Customer Signature
						</td>
					</tr>
