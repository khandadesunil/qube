<?php
	...
	$select_bmo = "select max(ID) as bmo_num from process where bmo_number != ''";
	$result_bmo = sqlsrv_query($conn, $select_bmo);
	$row_bmo_number = sqlsrv_fetch_array($result_bmo);
	$bmo_num = INTVAL(1001) + $row_bmo_number['bmo_num'];
	...
	if($bmo != ''){
		...
		if($LR_ID != ''){
			...
			$last_bmo_id = sqlsrv_get_field($sql, 0);
			if ($res) {
								...
								<div class="widget widget-table action-table">
									...
									<div class="widget-content"><br />
										...
										<div class="widget-content">
											<table class="table table-striped table-bordered" >
												...
												<tbody>
													<?php
														...
														$sel_lr = "select ID, CONSR, LR_NUMBER, CONVERT(VARCHAR(10), LR_DATE,105) as LR_DATE, (select NAME from city where ID = FROM_BRANCH) AS FROM_BRANCH, (select NAME from city where ID = TO_BRANCH) AS TO_BRANCH, 
																CONSR_EMAIL, LR_TYPE, GOODS, SHIPPER, STATUS, CREATED_DATE from lr where status = 'Active' ".$condi;
														//echo $sel_lr;
											...
											<table border="0" width="80%">
												...
												<tr>
													...
													<td>
														...
														<input type="text" name="ETD" id="ETD" value="<?=date('d-m-Y');?>" class="span2 tcal">
													</td>
													<td>
														ETA
													</td>	
											...
											<input type="submit" name="bmo" id="bmo" value="Create BMO" class="btn btn-primary">
											<a class="btn" href="list_bmo.php"  tabindex="21">Back</a><br /><br />
											</center>
										</div>
										</form>	
									</div>	
