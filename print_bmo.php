<?php
	...
	$sel_ts = "select p.*, CONVERT(VARCHAR(10), p.BMO_DATE,110) as BMO_DATE from process p where p.ID = ".$ID;
				...
				<table width="700" border="1" style="border:0px;">
					...
					<tr style="height:70px;">
						<th colspan="9">
							...
							<div style="float:left;width:230px;">Trip Sheet Date <br /><br /> <?=$BMO_DATE?></div>
							<div style="float:left;width:230px;">Scheduled Date <br /><br /> <?=$BMO_DATE?></div>
						</th>
					</tr>
